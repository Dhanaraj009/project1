                    ...
                    <div class="card-body">
                        <form action="insrt.php" id="frm" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="uage" id="uage" class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" name="unumber" id="unumber">
                            </div>
                            <div class="form-group">
                                <label for="udist">district</label>
                                <input type="text" id="udist" class="form-control" name="udist">
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" name="sbmt" value="create">submit</button>
                            </div>
                        </form>
