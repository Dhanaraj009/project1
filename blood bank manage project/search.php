        ...
        <div class="row mt-5 justify-content-between ">
            <div class="col-sm-3 bg ">
                ...
                <div class="df mt-5 text-center">
                    ...
                    <div>
                        <h3><a href="">SEARCH BLOOD GROUPS</a></h3>
                    </div>
                ...
                <br>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2>search the blood here!</h2>
                            </div>
                            <div class="card-body">
                                <form action="searchres.php" method="post">
                                    <div class="form-group">
                                        <label for="">blood group</label>
                                        <input type="text"name="usblood" class="form-control">
                                    </div>
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="sbmt" value="search">search</button>
                                    </div>
                                </form>
                            </div>
                        </div>
